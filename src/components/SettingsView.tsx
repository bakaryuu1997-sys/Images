...
export default function SettingsView({ 
  ...
  const handlePurgeClick = () => {
    if (window.confirm(" Are you absolutely sure you want to permanently delete all saved images from your Gallery? This action is non-reversible!")) {
      onClearGallery();
      setToastMessage("Gallery cleared successfully.");
          ...
          <CardContent className="p-6">
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <FormControl fullWidth className="bg-black/25 rounded-xl border border-white/5">
                <InputLabel id="default-ratio-label" className="text-zinc-400">Default Aspect Ratio</InputLabel>
                <Select
                ...
                >
                  <MenuItem value="1:1" className="bg-zinc-950 hover:bg-zinc-900">1:1 (Square)</MenuItem>
                  <MenuItem value="16:9" className="bg-zinc-950 hover:bg-zinc-900">16:9 (Landscape HD)</MenuItem>
                  <MenuItem value="9:16" className="bg-zinc-950 hover:bg-zinc-900">9:16 (Vertical Story)</MenuItem>
                  <MenuItem value="4:3" className="bg-zinc-950 hover:bg-zinc-900">4:3 (Traditional Portrait)</MenuItem>
                  <MenuItem value="3:4" className="bg-zinc-950 hover:bg-zinc-900">3:4 (Photo Aspect)</MenuItem>
                </Select>
              </FormControl>

              <FormControl fullWidth className="bg-black/25 rounded-xl border border-white/5">
                <InputLabel id="default-style-label" className="text-zinc-400">Default Style Theme</InputLabel>
                <Select
                  labelId="default-style-label"
                  id="default-style-select"
                  value={settings.style}
                  label="Default Style Theme"
              ...
              <FormControl fullWidth className="bg-black/25 rounded-xl border border-white/5">
                <InputLabel id="default-quality-label" className="text-zinc-400">Default Resolution Quality</InputLabel>
                <Select
                  labelId="default-quality-label"
                  id="default-quality-select"
                  value={settings.quality}
                  label="Default Resolution Quality"
                ...
                >
                  <MenuItem value="standard" className="bg-zinc-950 hover:bg-zinc-900">Standard (Fast, Octane Render Optimized)</MenuItem>
                  <MenuItem value="highest" className="bg-zinc-950 hover:bg-zinc-900">HD Premium (Imagen High Fidelity)</MenuItem>
                </Select>
              </FormControl>
                ...
                <FormControlLabel
                  ...
                  label={
                    <div className="flex flex-col ml-1">
                      ...
                      <span className="text-xs text-zinc-400 mt-0.5">Use Gemini to enrich drafts automatically prior to compilation.</span>
                    </div>
                  }
                />
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="text-xs text-zinc-400 font-sans max-w-sm">
                  {apiKeyStatus === "valid" ? (
                    ...
                    "Sending test signal request packets to the Express gateway proxy..."
                  ) : (
                    <span className="text-rose-400 font-semibold block">
                      Warning: No active key detected. Go to Settings &gt; Secrets inside the AI Studio top toolbar panel to verify bindings.
                    </span>
                  )}
                </div>
              </div>
        ...
        <Card className="border border-white/10 bg-white/5 backdrop-blur-md text-white rounded-2xl overflow-hidden shadow-xl">
          <CardContent className="p-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 rounded-xl border border-rose-500/20 bg-rose-500/5 backdrop-blur-sm">
              <div>
                <span className="text-sm font-bold text-zinc-200 block">Saved Artworks Catalog</span>
                <span className="text-xs text-zinc-500 mt-1 block">Currently hosting {savedImagesCount} items in LocalStorage.</span>
              </div>
              <Button
                variant="contained"
